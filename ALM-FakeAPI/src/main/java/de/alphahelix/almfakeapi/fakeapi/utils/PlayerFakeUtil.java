...
package de.alphahelix.almfakeapi.fakeapi.utils;
...
import de.alphahelix.almfakeapi.fakeapi.FakeRegister;
import de.alphahelix.almfakeapi.fakeapi.instances.FakeEntity;
...
import de.alphahelix.almitem.SkullItemBuilder;
import de.alphahelix.almreflections.nms.REnums.REnumEquipSlot;
import de.alphahelix.almreflections.nms.REnums.REnumGamemode;
import de.alphahelix.almreflections.nms.REnums.REnumPlayerInfoAction;
import de.alphahelix.almreflections.reflection.PacketUtil;
...
public class PlayerFakeUtil extends FakeUtilBase {
    ...
    public static FakePlayer spawnTemporaryPlayer(final Player p, final Location loc, GameProfile skin, final String customName) {
        try {
            ...
            }.runTaskLater(ALMCore.getInstance(), 4);
    ...
    public static void followPlayer(final Player p, final Player toFollow, final FakePlayer npc) {
        ...
        }.runTaskTimer(ALMCore.getInstance(), 0, 1));
    }
    ...
    public static void splitTeleportPlayer(final Player p, final Location to, final int teleportCount, final long wait, final FakePlayer npc) {
        try {
            ...
            }.runTaskTimer(ALMCore.getInstance(), 0, wait));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
