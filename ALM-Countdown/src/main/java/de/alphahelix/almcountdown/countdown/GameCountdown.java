package de.alphahelix.almcountdown.countdown;

import de.alphahelix.almcore.ALMCore;
import de.alphahelix.almcountdown.events.CountDownFinishEvent;
import de.alphahelix.almcountdown.events.CountDownStartEvent;
import de.alphahelix.almcountdown.events.CountDownTimeEvent;
import de.alphahelix.almreflections.nms.SimpleActionBar;
import de.alphahelix.almreflections.nms.SimpleTitle;
...
public class GameCountdown {
    ...
    public void start(String titleMessage) {
        ...
        }.runTaskTimer(ALMCore.getInstance(), 0L, 20L).getTaskId();
    }
